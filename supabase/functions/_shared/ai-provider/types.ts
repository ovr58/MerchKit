 ...
 *
 * **Веха M7 разворачивает это решение в части вёрстки, но не в части сцены**
 * ([ADR-0012](../../../../docs/adr/0012-card-layout-is-ours-not-vendors.md)): сцену
 * по-прежнему рисует вендор одним кадром, а заголовок, характеристики и логотип ставит наш
 * сборщик поверх — значит, к профилю площадки готовый файл теперь **приводится** сборкой, а
 * не только проверяется на соответствие.
 */
