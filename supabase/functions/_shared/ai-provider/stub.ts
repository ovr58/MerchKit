 ...
 * `AI_STUB_FAILURE` (`images` · `card` · `all`). Точечно, на одну генерацию, — префиксом в
 * наименовании товара; так сценарий проходится руками и скриптом, не перезапуская функции:
 *
 ...
 *
 * Эти крючки живут **только здесь** и уезжают вместе с заглушкой на M5.
 *
