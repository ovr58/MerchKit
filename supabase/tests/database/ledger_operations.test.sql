...
--
-- Списание проверяется на **фиктивном потребителе**: генерации как сущности ещё нет, она
-- приезжает на M4. В этом и смысл — журнал, спроектированный без потребителя, не переделать,
-- когда на нём уже висят реальные операции.
...
-- Списание и возврат по V-07 на фиктивной генерации.
select is(
