...
магазине», «раскладка сверху», «каталог») либо целиком карточку товара — одно готовое
изображение с вёрсткой поверх фото, вместе с заголовком и описанием. Генерации складываются в личный каталог, оплата — внутренними
баллами.
