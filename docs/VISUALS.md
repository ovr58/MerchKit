...
**Статус: опубликован 2026-08-27 заходом D1** — 13 десктопных артбордов вехи M2.
...
- **D1 (перед M2) — на канвасе:** вход (+ неверная пара) · регистрация (+ ошибки полей) ·
  ...
  пароль) · профиль до подтверждения и после · пакеты пополнения · состояния каталога
...
- **Цифры на артбордах расчётные:** N = 20 стартовых баллов, 10 баллов за объект, пакеты
  100 / 300 / 1 000 — из [`UNIT_ECONOMICS.md`](../planning/reference/UNIT_ECONOMICS.md).
  В [`TZ.md`](TZ.md) §11 эти пункты ещё открыты; меняются цифры — правится и канвас.
...
**Статус: не опубликован** (сервис артефактов вернул 403 на публикацию 2026-08-27; переиздать,
когда откроется). Исходник — [`design/economics/ekonomika-merch-kit.html`](design/economics/ekonomika-merch-kit.html),
