...
Инвентарь трёх баз офлайн-конвейера (шаг A7 плана
[`card-assembly-pipeline_2026-08-31.md`](../planning/active/card-assembly-pipeline_2026-08-31.md)).
Не отчёт о достижениях, а рабочий инструмент пополнения: пустые слоты видны так же ясно, как
заполненные.

- **Образцы** — 7 категорий × 3 площадки = 21 ячейка «папками с файлами»; на каждой ячейке
  метки требований площадки (3 : 4 · серый фон Ozon · квадрат Ozon Fresh). Отдельно полка
  неразобранного: три файла V-10.
...
**Страница отражает состояние на 2026-08-31 (переиздана в тот же день после шага A5) и
переиздаётся дальше по мере наполнения баз** — счётчики в шапке и статусы ячеек правятся в
исходнике, URL остаётся прежним.
