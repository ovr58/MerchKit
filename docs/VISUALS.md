...
**Статус: не опубликован.** Заводится заходом D1 перед вехой M2 — см. раздел «Дизайн» в
...
- **Приоритет — десктоп.** Десктопные артборды обязательны для каждого экрана. Мобильные
  ...
  и каталог (NFR-09).
- **D1 (перед M2):** вход · регистрация · «подтвердите email» · восстановление пароля ·
  профиль с балансом и пакетами · пустые состояния.
...
> Ссылка на артефакт появляется здесь в момент публикации.
