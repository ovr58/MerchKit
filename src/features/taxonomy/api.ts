 ...
 *
 * **`select` выдан и `anon`** — с тех пор, как мастер проходился гостем. С закрытием
 * мастера (FR-12, 2026-09-01) нужда отпала, но грант остался: это справочник на 38 строк
 * без единого пользовательского данного, и снимать его отдельной миграцией незачем.
 * Экраны спрашивают справочник здесь, а не запросом в таблицу.
 *
