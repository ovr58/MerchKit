 ...
 *
 * **Мастер — только для вошедшего** (FR-12, решение пользователя 2026-09-01): гостя не
 * пускает гвард маршрута, потому что уже шаг распознавания стоит денег. Настройки при этом
 * не теряются — черновик живёт в браузере и переживает регистрацию с подтверждением email.
 *
            ...
            <>
              ...
              <div className="flex flex-col gap-2 sm:flex-row">
                ...
                <Button
                  ...
                  size="lg"
                >
                  {/* Без цены в подписи: она стоит строкой выше («К списанию»), а на узком
                      экране длинная подпись с `whitespace-nowrap` растягивала страницу. */}
