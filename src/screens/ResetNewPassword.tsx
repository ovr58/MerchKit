...
export default function ResetNewPassword() {
  ...
  // Шапка намеренно без ссылки: на артборде D1 её нет. Человек пришёл сюда по ссылке из
  // письма, и уводить его отсюда «Войти» — значит предложить ему то, чего он как раз не
  // может сделать: старый пароль он и забыл.
  return (
    <AuthLayout>
      <AuthHeading
        description="Задайте новый пароль — старый перестанет действовать сразу."
        title="Новый пароль"
      />
